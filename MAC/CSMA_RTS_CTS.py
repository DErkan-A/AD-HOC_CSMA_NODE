...
class MacCsmaRTS_CTS_ConfigurationParameters (ComponentConfigurationParameters):
    def __init__(self, slot_time = 0.001, NAV_RTS = 0.020, NAV_CTS = 0.015, NAV_DATA = 0.010, cca_threshold = -35):
                    ...
                    if  clearmi == True:
                        ...
                        if  clearmi == True:
                            try:
                                ...
                                print(f"Node{self.componentinstancenumber}, Sending RTS to Node{eventobj.eventcontent.header.messageto}")
